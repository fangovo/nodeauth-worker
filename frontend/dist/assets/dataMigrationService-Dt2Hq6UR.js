const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/qr-utils-7t4IiZrV.js","assets/element-plus-BHS6vjDl.js","assets/vue-core-DHcoxuim.js","assets/element-plus-CqJ-3YyC.css","assets/index-CFsDC6RG.js","assets/pdf-utils-D3SLYqmy.js","assets/compression-utils-BzBbrBKd.js","assets/simplewebauthn-3qpiAaRi.js","assets/tanstack-query-DV2JH8XC.js","assets/index-BvTGjkv3.css"])))=>i.map(i=>d[i]);
import { _ as ne, __tla as __tla_0 } from "./pdf-utils-D3SLYqmy.js";
import { n as pe, O as _e, p as V, b as ee, v as fe, __tla as __tla_1 } from "./vaultService-BoND02Dg.js";
...
import { x as ue, o as Ue, q as De, __tla as __tla_2 } from "./index-CFsDC6RG.js";
...
`)[0].toLowerCase() : "";
    ...
    const Ve = {
        ...
        async exportToGoogleAuth (n) {
            ...
            const i = Math.floor(Math.random() * 2147483647), c = await ne(()=>import("./qr-utils-7t4IiZrV.js").then((A)=>A.b), __vite__mapDeps([0,1,2,3])), u = [];
            function g(A, y) {
            ...
            (function(e) {
                function s(f) {
                    ...
                    function I(H) {
                        let Q = 0, k = H.length;
                        for(; k >= 64;){
                            let N = a, K = h, $ = l, z = p, T = d, B = _, O = b, Y = S, F, R, X, Z, te;
                            ...
                            for(R = 0; R < 64; R++)Z = (((T >>> 6 | T << 26) ^ (T >>> 11 | T << 21) ^ (T >>> 25 | T << 7)) + (T & B ^ ~T & O) | 0) + (Y + (o[R] + v[R] | 0) | 0) | 0, te = ((N >>> 2 | N << 30) ^ (N >>> 13 | N << 19) ^ (N >>> 22 | N << 10)) + (N & K ^ N & $ ^ K & $) | 0, Y = O, O = B, B = T, T = z + Z | 0, z = $, $ = K, K = N, N = Z + te | 0;
                            a = a + N | 0, h = h + K | 0, l = l + $ | 0, p = p + z | 0, d = d + T | 0, _ = _ + B | 0, b = b + O | 0, S = S + Y | 0, Q += 64, k -= 64;
                        }
                    }
                    I(f);
...
`;
            return n.forEach((e)=>{
                const t = `"${e.service}${e.account ? ":" + e.account : ""}"`, s = e.type === "steam" ? `steam://${e.secret}` : ee(e);
                r += `${t},${e.secret},"${s}",0,
`;
            }), r;
        }
        ...
        exportPlaintext (n) {
            const r = {
                version: 1,
                entries: n.map((e)=>{
                    const t = e.type === "steam", s = t ? `steam://${e.secret}` : ee(e);
                    return {
        ...
        async fetchAllVault () {
            ...
            try {
                const { useAppLockStore: e } = await ne(async ()=>{
                    const { useAppLockStore: c } = await import("./index-CFsDC6RG.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((u)=>u.b);
                    return {
                    ...
                    const { unmaskSecretFront: c } = await import("./index-CFsDC6RG.js").then(async (m)=>{
                        await m.__tla;
                        return m;
                    }).then((u)=>u.m);
                    return {
